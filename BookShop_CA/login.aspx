...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-xs-12">
        <div style="width: 400px; margin-left: auto; margin-right: auto;">
            <asp:Login ID="Login1" runat="server" Width="360px" TextLayout="TextOnTop" Orientation="Vertical" DisplayRememberMe="False" TitleText="" OnAuthenticate="Login1_Authenticate1">
